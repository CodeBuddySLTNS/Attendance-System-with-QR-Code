...
const Header: React.FC = () => {
  ...
  return (
    loggedIn && (
      <div className="fixed top-0 left-0 right-0 w-full flex justify-between items-center px-4 py-2.5 z-50 bg-gradient-to-r from-[#0E2148] via-[#1a3a6b] to-[#0E2148] shadow-lg border-b border-white/10">
